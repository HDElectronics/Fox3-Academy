 ...
 * - Every bind declares its group and keyboard default (null when absent or unverified). Notes are prose.
...
function ruBinds(id: 'su27' | 'su33' | 'j11a' | 'mig29s'): KeyBind[] {
  ...
  return [
    { group: 'radar', keyboard: '2', action: 'BVR mode', keys: '2', note: '"(2) Beyond Visual Range Mode"' },
    { group: 'radar', keyboard: 'I', action: 'Radar on / off', keys: 'I', note: '"Radar On/Off". ИЗЛ shows on the HUD while it transmits.' },
    {
      group: 'radar', keyboard: 'RAlt + I', action: id === 'mig29s' ? 'RWS / TWS (ОБЗ / СНП / СНП2)' : 'RWS / TWS (ОБЗ / СНП)', keys: 'RAlt + I',
      note: id === 'mig29s' ? '"Radar RWS/TWS Mode Select". Press twice from ОБЗ for СНП2.' : '"Radar RWS/TWS Mode Select"',
    },
    { group: 'radar', keyboard: 'RShift + I', action: 'PRF ППС / ЗПС / АВТ', keys: 'RShift + I', note: '"Radar Pulse Repeat Frequency Select". СНП needs ППС or ЗПС.' },
    { group: 'radar', keyboard: 'Enter', action: 'Designate / lock (STT)', keys: 'Enter', note: '"Target Lock"' },
    { group: 'radar', keyboard: 'Backspace', action: 'Unlock', keys: 'Backspace', note: '"Target Unlock". Medium confidence: taken from mod copies of the FC3 bindings.' },
    { group: 'radar', keyboard: '; , . /', action: 'Cursor slew', keys: '; , . /', note: '"Target Designator Up / Left / Down / Right"' },
    { group: 'radar', keyboard: 'RCtrl + I', action: 'Cursor to centre', keys: 'RCtrl + I', note: '"Target Designator To Center"' },
    { group: 'radar', keyboard: '= / -', action: 'Display range in / out', keys: '= / -', note: '"Display Zoom In/Out"' },
    { group: 'radar', keyboard: 'RShift + , / RShift + /', action: 'Scan zone left / right (three 60° positions)', keys: 'RShift + , / RShift + /', note: '"Scan Zone Left/Right"' },
    { group: 'radar', keyboard: 'RShift + ; / RShift + .', action: 'Scan elevation (height difference)', keys: 'RShift + ; / RShift + .', note: '"Scan Zone Up/Down"' },
    { group: 'radar', keyboard: 'RCtrl + = / RCtrl + -', action: 'Expected target range (range-angle aiming)', keys: 'RCtrl + = / RCtrl + -', note: 'Listed as "Radar Scan Zone Increase/Decrease"' },
    { group: 'radar', keyboard: 'O', action: 'IRST on / off', keys: 'O', note: '"Electro-Optical System On/Off". No RWR warning for the target.' },
    { group: 'weapons', keyboard: 'D / C', action: 'Weapon cycle / gun', keys: 'D / C', note: '"Weapon Change" / "Cannon"' },
    { group: 'weapons', keyboard: 'Space', action: 'Launch (hold at least 1 s)', keys: 'Space', note: 'Hold for at least 1 s. The F-15C manual lists missiles on RAlt + Space ("Weapon Release"); the Russian FC3 manuals use Space.' },
    { group: 'weapons', keyboard: 'LAlt + W', action: 'Launch permission override', keys: 'LAlt + W', note: '"Launch Permission Override"' },
    { group: 'defence', keyboard: 'Insert', action: 'Chaff', keys: 'Insert', note: '"Countermeasures Chaff Dispense"' },
    { group: 'defence', keyboard: 'Delete', action: 'Flares', keys: 'Delete', note: '"Countermeasures Flares Dispense"' },
    { group: 'defence', keyboard: 'Q / LShift + Q', action: 'Countermeasure program / continuous', keys: 'Q / LShift + Q', note: '"Countermeasures Release" / "Countermeasures Continuously Dispense"' },
    { group: 'defence', keyboard: 'E', action: 'ECM jammer', keys: 'E', note: `"ECM". ${ecm}` },
    { group: 'radar', keyboard: '3 / 4 / 5 / 6', action: 'Close combat: vertical scan / bore / helmet / Fi0', keys: '3 / 4 / 5 / 6', note: 'VS, BORE and HELMET default to the IRST and an IR missile.' },
    { group: 'defence', keyboard: 'RShift + R / RAlt + , and RAlt + .', action: 'RWR mode / volume', keys: 'RShift + R / RAlt + , and RAlt + .', note: '"RWR/SPO Mode Select" / "RWR/SPO Sound Signals Volume Down/Up"' },
  ];
}
...
const F15C_BINDS: KeyBind[] = [
  { group: 'radar', keyboard: 'I', action: 'Radar on / off', keys: 'I', note: '"Radar On/Off"' },
  { group: 'radar', keyboard: '2', action: 'BVR search (LRS)', keys: '2', note: '"(2) Beyond Visual Range Mode"' },
  { group: 'radar', keyboard: 'RAlt + I', action: 'RWS / TWS', keys: 'RAlt + I', note: '"Radar RWS/TWS Mode Select". The manual quick reference says RCtrl + I, which is really Target Designator To Center.' },
  { group: 'radar', keyboard: 'RShift + I', action: 'PRF HI / MED / interleaved', keys: 'RShift + I', note: '"Radar Pulse Repeat Frequency Select"' },
  { group: 'radar', keyboard: 'Enter', action: 'Designate / lock (Enter again on a designated target = STT)', keys: 'Enter', note: '"Target Lock"' },
  { group: 'radar', keyboard: 'Backspace', action: 'Unlock / drop all designations', keys: 'Backspace', note: '"Radar - Return To Search/NDTWS"' },
  { group: 'radar', keyboard: null, action: 'Remove one TWS designation', keys: 'No default key', note: '"Unlock TWS Target": bind it yourself.' },
  { group: 'radar', keyboard: '; , . /', action: 'Cursor (TDC) slew', keys: '; , . /', note: '"Target Designator Up / Left / Down / Right"' },
  { group: 'radar', keyboard: 'RCtrl + I', action: 'Cursor to centre', keys: 'RCtrl + I', note: '"Target Designator To Center"' },
  { group: 'radar', keyboard: '= / -', action: 'Range scale', keys: '= / -', note: '"Display Zoom In/Out". Bumping the TDC at the top or bottom of the VSD also works.' },
  { group: 'radar', keyboard: 'RCtrl + = / RCtrl + -', action: 'Scan width ±60° / ±30°', keys: 'RCtrl + = / RCtrl + -', note: '"Radar Scan Zone Increase/Decrease"' },
  { group: 'radar', keyboard: 'RShift + ; / RShift + .', action: 'Antenna elevation', keys: 'RShift + ; / RShift + .', note: '"Scan Zone Up/Down"' },
  { group: 'radar', keyboard: 'RShift + , / RShift + /', action: 'Scan zone left / right (TWS window)', keys: 'RShift + , / RShift + /', note: '"Scan Zone Left/Right"' },
  { group: 'radar', keyboard: '3 / 4', action: 'Vertical scan / boresight', keys: '3 / 4', note: '"(3) Close Air Combat Vertical Scan Mode" / "(4) Close Air Combat Bore Mode"' },
  { group: 'weapons', keyboard: '6', action: 'FLOOD (AIM-7) / VISUAL (AIM-120)', keys: '6', note: '"(6) Longitudinal Missile Aiming Mode/FLOOD mode"' },
  { group: 'weapons', keyboard: 'D / C', action: 'Weapon cycle / gun', keys: 'D / C', note: '"Weapon Change" / "Cannon"' },
  { group: 'weapons', keyboard: 'RAlt + Space', action: 'Launch missile', keys: 'RAlt + Space', note: '"Weapon Release". Space ("Weapon Fire") is the gun trigger; it is reported to launch missiles too (unverified).' },
  { group: 'defence', keyboard: 'Insert', action: 'Chaff', keys: 'Insert', note: '"Countermeasures Chaff Dispense"' },
  { group: 'defence', keyboard: 'Delete', action: 'Flares', keys: 'Delete', note: '"Countermeasures Flares Dispense"' },
  { group: 'defence', keyboard: 'E', action: 'ECM (AN/ALQ-135)', keys: 'E', note: '"ECM". Open X in the TEWS centre: flashing = warming up, steady = on.' },
  { group: 'defence', keyboard: 'RShift + R / RAlt + , and RAlt + .', action: 'RWR mode / volume', keys: 'RShift + R / RAlt + , and RAlt + .', note: '"RWR/SPO Mode Select" / "RWR/SPO Sound Signals Volume Down/Up"' },
];
...
const FA18C_BINDS: KeyBind[] = [
  { group: 'radar', keyboard: null, action: 'Radar on / off', keys: 'RADAR knob: OPR / STBY / OFF', note: 'Sensor panel knob. The controls-menu name and key were not in research.' },
  { group: 'radar', keyboard: 'RAlt + /', action: 'TDC to the radar DDI; in TWS: STT on the L&S; with no target under the TDC: AACQ', keys: SCS_RIGHT, note: '"Toward the radar DDI", normally the right DDI.' },
  { group: 'radar', keyboard: 'Enter', action: 'Radar mode RWS / VS / TWS', keys: `${TDC_DEPRESS} on the PB5 mode legend`, note: 'Key Enter with the TDC over the mode legend.' },
  { group: 'radar', keyboard: '; . , /', action: 'Cursor slew', keys: 'Throttle Designator Controller - Up / Down / Left / Right' },
  { group: 'radar', keyboard: 'Enter', action: 'Designate: L&S, then DT2 (hold > 1 s = SPOT)', keys: TDC_DEPRESS },
  { group: 'radar', keyboard: 'S', action: 'Undesignate: step L&S, swap L&S and DT2, leave STT or ACM', keys: UNDESIGNATE },
  { group: 'radar', keyboard: 'I', action: 'RAID / SCAN RAID', keys: 'RAID/FLIR FOV Select Button' },
  { group: 'radar', keyboard: '= / -', action: 'Antenna elevation', keys: 'Radar Elevation Control - Up / Down' },
  { group: 'radar', keyboard: null, action: 'Range scale', keys: `${TDC_DEPRESS} on the range arrows`, note: 'In TWS the range steps up by itself to keep the targets on scale.' },
  { group: 'radar', keyboard: null, action: 'Azimuth / bars / PRF', keys: 'DDI pushbuttons by the azimuth ("140"), bar ("4B") and PRF legends', note: 'Exact pushbutton numbers are not in research.' },
  { group: 'weapons', keyboard: 'LShift + D / LShift + W / LShift + S / LShift + X', action: 'Weapon select AMRAAM / Sparrow / Sidewinder / gun', keys: 'Select AMRAAM / Select Sparrow / Select Sidewinder / Select Gun' },
  { group: 'weapons', keyboard: 'M', action: 'Master Arm', keys: 'Master Arm Switch - ARM/SAFE' },
  { group: 'weapons', keyboard: 'Space', action: 'Launch A/A missile', keys: 'Trigger', note: 'A/A missiles fire on the trigger, not the Weapon Release button (RAlt + Space).' },
  { group: 'weapons', keyboard: 'C', action: 'AIM-9 cage / uncage (AIM-7: STT on the L&S)', keys: 'Cage/Uncage Button' },
  { group: 'radar', keyboard: 'RAlt + ; / RAlt + . / RAlt + ,', action: 'ACM: boresight (BST) / vertical (VACQ) / wide (WACQ)', keys: 'Sensor Control Switch - Fwd / Aft / Left', note: '(the manual prints LAlt + , for Left)' },
  { group: 'defence', keyboard: 'E', action: 'Chaff: MAN program 5 or consent (BYPASS: single chaff)', keys: 'Dispense Switch - Forward' },
  { group: 'defence', keyboard: 'D', action: 'Flares: EW-page MAN program (BYPASS: single flare)', keys: 'Dispense Switch - Aft' },
];
...
const F16C_BINDS: KeyBind[] = [
  { group: 'radar', keyboard: null, action: 'Radar on / off', keys: 'FCR switch (sensor power panel)', note: 'Not in research; cockpit switch. Check the controls menu.' },
  { group: 'radar', keyboard: 'RAlt + .', action: 'FCR as sensor of interest', keys: 'Display Management Switch - Down' },
  { group: 'radar', keyboard: null, action: 'Radar mode RWS / VSR / TWS', keys: 'FCR OSB 2', note: 'Cockpit pushbutton. Holding TMS Right 1 s also toggles TWS.' },
  { group: 'radar', keyboard: 'RCtrl + Right', action: 'TWS on / off (hold 1 s); upgrade all and bug closest; step bug', keys: TMS_RIGHT },
  { group: 'radar', keyboard: 'RCtrl + Up', action: 'Upgrade / bug; on the bug: STT; hold: Spotlight', keys: TMS_UP },
  { group: 'radar', keyboard: 'RCtrl + Down', action: 'Reject, downgrade, unlock, back to RWS', keys: TMS_DOWN },
  { group: 'radar', keyboard: 'RCtrl + Left', action: 'IFF (short) / NCTR (long)', keys: 'Target Management Switch - Left' },
  { group: 'radar', keyboard: '; . , /', action: 'Cursor slew', keys: 'RDR CURSOR Switch - Up / Down / Left / Right' },
  { group: 'radar', keyboard: null, action: 'Range scale', keys: 'FCR OSB 19 / OSB 20, or bump the cursor', note: 'Cockpit pushbuttons.' },
  { group: 'radar', keyboard: null, action: 'Azimuth / bars', keys: 'FCR OSB 18 (A6 / A3 / A1) / OSB 17 (4B / 2B / 1B)', note: 'A2 and 3B come only with a bug in TWS.' },
  { group: 'radar', keyboard: '= / -', action: 'Antenna elevation', keys: 'ANT ELEV Knob - CW / CCW' },
  { group: 'weapons', keyboard: '4', action: 'AIM-120 (missile override)', keys: 'DOGFIGHT/Missile Override Switch - MISSILE OVERRIDE/CENTER' },
  { group: 'weapons', keyboard: '3', action: 'Dogfight (ACM)', keys: 'DOGFIGHT/Missile Override Switch - DOGFIGHT/CENTER' },
  { group: 'weapons', keyboard: 'S', action: 'Missile step (short: station, long: type)', keys: 'NWS A/R DISC MSL STEP Button' },
  { group: 'weapons', keyboard: 'RAlt + Space', action: 'Launch (press and hold)', keys: WPN_REL },
  { group: 'weapons', keyboard: 'C', action: 'Uncage AIM-9', keys: 'UNCAGE Switch' },
  { group: 'defence', keyboard: null, action: 'Countermeasures: manual 1–4 / manual 6 / ECM off / auto consent', keys: 'Countermeasures Management Switch - Fwd / Left / Right / Aft', note: 'No default key found (Nov 2023 clean profile).' },
  { group: 'defence', keyboard: null, action: 'Manual program 5', keys: 'CHAFF/FLARE Dispense button', note: 'Left cockpit wall. No default key found.' },
];
...
const F14B_BINDS: KeyBind[] = [
  { group: 'radar', keyboard: 'A', action: 'Jester menu', keys: 'Toggle Menu', note: '(1st press context menu, 2nd main menu, 3rd close); items LCtrl + 1 … LCtrl + 8.' },
  { group: 'radar', keyboard: null, action: 'Radar on, mode, range, scan (through Jester)', keys: 'Jester: Beyond Visual Range – Radar', note: 'Mode RWS / TWS / PD / pulse, scan range 25–400 nm, elevation, azimuth. Petal wording is not verified.' },
  { group: 'radar', keyboard: null, action: 'Lock / unlock (through Jester)', keys: 'Jester: lock closest / at azimuth and range / from the TWS list', note: 'Unlock petal wording is not verified.' },
  { group: 'radar', keyboard: null, action: 'Cursor, hook, manual lock (RIO seat)', keys: 'HCU half-action / full-action', note: 'The pilot has no radar cursor; a human RIO hooks and locks with the HCU.' },
  { group: 'weapons', keyboard: null, action: 'Weapon select GUN / SW / SP-PH', keys: 'Weapon Selector UP / DOWN' },
  { group: 'weapons', keyboard: null, action: 'Sparrow ↔ Phoenix', keys: 'Weapon Selector Press' },
  { group: 'weapons', keyboard: null, action: 'Launch', keys: TRIGGER_F14, note: 'Default key not verified (candidate: Space). About 3 s from trigger to missile away.' },
  { group: 'radar', keyboard: null, action: 'ACM lock: PAL (±20°, 8-bar, 15 nm)', keys: 'Target Designate Forward / PAL' },
  { group: 'radar', keyboard: null, action: 'ACM lock: VSL HI / VSL LO (5 nm)', keys: 'Target Designate UP / VSL HI; Target Designate DOWN / VSL LO' },
  { group: 'radar', keyboard: null, action: 'ACM lock: PLM (5 nm on the ADL)', keys: 'PLM Button' },
  { group: 'weapons', keyboard: null, action: 'Missile prep / Master Arm', keys: 'MSL PREP switch; Master Arm switch (ACM panel)', note: 'MSL PREP about 2 min before the fight.' },
  { group: 'weapons', keyboard: null, action: 'Phoenix options (RIO)', keys: 'DDD TGTS switch; MSL OPTIONS NORM / SP PD / PH ACT', note: 'RIO controls. PH ACT must be set before launch.' },
  { group: 'defence', keyboard: null, action: 'Countermeasures', keys: 'DLC Toggle / Countermeasure Dispense', note: 'Pilot control with flaps up; FLARE MODE determines flare/chaff release. Default keyboard key for the classic F-14B remains not verified. See verification-status.md.' },
];
...
const JF17_BINDS: KeyBind[] = [
  { group: 'radar', keyboard: null, action: 'Master mode A/A (INTC)', keys: 'Master Mode Switch (T1) - UP / FWD', note: 'Controls-menu wording not in research.' },
  { group: 'radar', keyboard: null, action: 'Radar on / off', keys: 'Radar MFCD OSB "STBY"', note: '"STBY" crossed out = radar on.' },
  { group: 'radar', keyboard: null, action: 'Radar as sensor of interest', keys: 'Sensor Selection (S1) - AFT', note: 'The radar MFCD gets the "*".' },
  { group: 'radar', keyboard: null, action: 'Mode RWS / TWS / VS; swap HPT and SPT; ASM / NAM', keys: JF_S2_LEFT },
  { group: 'radar', keyboard: null, action: 'Range up / down', keys: 'Sensor Control (S2) - FWD / AFT' },
  { group: 'radar', keyboard: null, action: 'Azimuth width', keys: 'Sensor Control (S2) - RIGHT' },
  { group: 'radar', keyboard: null, action: 'Unlock / MFCD refresh', keys: 'Sensor Control (S2) - PRESS' },
  { group: 'radar', keyboard: null, action: 'Cursor slew', keys: 'TDC (T5)', note: 'Keyboard default not in research.' },
  { group: 'radar', keyboard: 'Enter', action: 'Bug HPT (1st press) / STT (2nd press)', keys: JF_TDC_PRESS },
  { group: 'radar', keyboard: null, action: 'Antenna elevation', keys: 'Antenna Elevation (T6)' },
  { group: 'radar', keyboard: null, action: 'ACM entry; then VT / BS / HA', keys: 'Sensor Selection (S1) - FWD; then S2 AFT / FWD / RIGHT' },
  { group: 'weapons', keyboard: null, action: 'Missile type / missile step', keys: 'Missile Type Selection (S8) / Missile Step (S5)' },
  { group: 'weapons', keyboard: 'RAlt + Space', action: 'Launch', keys: JF_REL },
  { group: 'weapons', keyboard: null, action: 'PL-5 uncage', keys: 'T2 - PRESS' },
  { group: 'radar', keyboard: null, action: 'IFF interrogate', keys: 'T4 - PRESS' },
  { group: 'defence', keyboard: null, action: 'Countermeasures', keys: 'T2 switch - AFT', note: 'Deka manual: pull T2 aft to dispense chaff/flares. English Controls-menu wording and default keyboard key not verified.' },
];
...
const M2K_BINDS: KeyBind[] = [
  { group: 'radar', keyboard: null, action: 'Radar emission', keys: 'Radar EM (emission) switch', note: 'Cockpit switch; the controls-menu name is not in research.' },
  { group: 'radar', keyboard: null, action: 'Preselect PIC (STT) / PID (single-target TWS)', keys: 'STT/TWS Toggle', note: 'No default key.' },
  { group: 'radar', keyboard: '; . , /', action: 'Cursor (alidade) slew', keys: 'TDC UP / DOWN / LEFT / RIGHT' },
  { group: 'radar', keyboard: null, action: 'Lock (PSIC)', keys: 'TDC DEPRESS (LOCK TARGET)', note: 'No default key.' },
  { group: 'radar', keyboard: null, action: 'Unlock', keys: 'Weapons System CMD Depressed', note: 'No default key.' },
  { group: 'radar', keyboard: null, action: 'Close combat vertical / horizontal; Pointé in PSIC Super 530', keys: 'Weapons System CMD FWD', note: 'No default key.' },
  { group: 'radar', keyboard: null, action: 'Close combat boresight', keys: 'Weapons System CMD AFT', note: 'No default key.' },
  { group: 'radar', keyboard: null, action: 'Antenna elevation', keys: 'Radar Antenna UP / DOWN / CENTER', note: 'No default key.' },
  { group: 'radar', keyboard: null, action: 'Range, azimuth, bars, PRF', keys: 'Radar control panel', note: 'Not in research: check the controls menu.' },
  { group: 'weapons', keyboard: 'C', action: 'Weapon: Super 530 / Magic / gun', keys: 'CNM switch: PCA Select (centre) / MAGIC SELECT (right) / AA Gun SELECT (left)', note: 'Key C for the gun. PCA 530 button to select the 530.' },
  { group: 'weapons', keyboard: 'Space', action: 'Launch (hold at least 2 s for the 530)', keys: 'MiCRoB / Trigger 2nd Stage' },
  { group: 'defence', keyboard: 'Delete / Insert', action: 'Countermeasure program / panic', keys: 'Decoy Program release / Decoy PANIC' },
  { group: 'defence', keyboard: 'E', action: 'Jammer', keys: 'Jammer toggle' },
  { group: 'radar', keyboard: 'S', action: 'IFF interrogate', keys: 'Nosewheel steering / IFF Interrogate' },
  { group: 'weapons', keyboard: null, action: 'Magic slave to radar / Magic unlock', keys: 'Magic Slave / AG Designate / INS Position Update; NAV Update / Magic Unlock', note: 'No default key.' },
];
